...
const defaultPtTranslations = {
  ...
  download: {
    ...
    subtitle:
      "Assinatura disponível para Android e iOS. Acompanhe séries, veja o que seus amigos assistem e conquiste badges.",
    googlePlay: "Baixar no Google Play",
    appStore: "Baixar na App Store",
    deviceRequirements: "iOS 12.0+ e Android 8.0+",
    freeWithInAppPurchases: "Acesso via assinatura mensal ou anual com todos os recursos sociais inclusos.",
...
const defaultEnTranslations = {
  ...
  screenshots: {
    ...
    list: [
      ...
      },
      {
        ...
        description: "Find series, actors and directors with ease.",
      },
      {
        src: "/images/screenshot-4.png",
        alt: "Trending Charts",
        title: "Trends Analysis",
        description: "Detailed charts about what's popular on streaming services.",
      },
    ],
    prev: "Previous",
    next: "Next",
  ...
  download: {
    ...
    titlePost: "community",
    subtitle:
      "Subscription available for Android and iOS. Track series, see what your friends watch and earn badges.",
    googlePlay: "Get it on Google Play",
    appStore: "Download on App Store",
    deviceRequirements: "iOS 12.0+ and Android 8.0+",
    freeWithInAppPurchases: "Monthly or annual subscription access with all social features included.",
...
const defaultEsTranslations = {
  ...
  screenshots: {
    ...
    list: [
      ...
      {
        src: "/images/screenshot-2.png",
        alt: "Búsqueda de Series",
        title: "Búsqueda Completa",
        description: "Encuentra series, actores y directores con facilidad.",
      },
      {
        src: "/images/screenshot-4.png",
        alt: "Gráficos de Tendencias",
        title: "Análisis de Tendencias",
        description: "Gráficos detallados sobre lo que es popular en los streamings.",
      },
    ],
    prev: "Anterior",
    next: "Siguiente",
  ...
  download: {
    ...
    titlePost: "comunidad",
    subtitle:
      "Suscripción disponible para Android e iOS. Sigue series, mira lo que tus amigos ven y gana badges.",
    googlePlay: "Descargar en Google Play",
    appStore: "Descargar en App Store",
    deviceRequirements: "iOS 12.0+ e Android 8.0+",
    freeWithInAppPurchases: "Acceso mediante suscripción mensual o anual con todas las funciones sociales incluidas.",
  ...
  screenshots: {
    ...
    list: [
      ...
      },
      {
        ...
        alt: "影集搜尋",
        title: "完整搜尋",
        description: "輕鬆查找影集、演員和導演。",
      },
      {
        src: "/images/screenshot-4.png",
        alt: "趨勢圖表",
        title: "趨勢分析",
        description: "串流平台上受歡迎內容的詳細圖表。",
      },
    ],
    prev: "上一個",
    next: "下一個",
