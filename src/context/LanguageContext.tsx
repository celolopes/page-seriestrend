...
const defaultEnTranslations = {
  ...
  comingSoon: {
    ...
    title: "Social Hub for",
    subtitle:
      "The next major update adds a social layer to bring series fans together inside the SeriesTrend community.",
    description:
      "With social integration through Trakt.tv, you will be able to identify friends, follow community profiles, and discover who else already uses SeriesTrend.",
    traktBadge: "Trakt.tv integration",
    previewLabel: "Preview of the new social screen",
    highlights: [
      "Social profile with followers, following, and friends.",
      "Community connected to your Trakt.tv account.",
      "Discovery of profiles and friendships inside the app.",
    ],
    note:
      "Some social features depend on Trakt.tv authentication and may still be refined before the official 4.0 release.",
    profileTitle: "Social Hub",
    profileSubtitle: "Connect with other series fans",
    profileName: "Marcelo Lopes",
    profileHandle: "@EuMarceloCae",
    profileLocation: "Florianópolis, Santa Catarina",
    profileSince: "August 2025",
    statsFollowers: "Followers",
    statsFollowing: "Following",
    statsFriends: "Friends",
    friendsTitle: "Friends on SeriesTrend",
    friendName: "Folincontro Eventos",
    friendHandle: "@Folincontro",
    communityTitle: "Community Members",
    emptyTitle: "No community profile has appeared yet",
    emptyDescription:
      "Refresh the community to load new profiles and discover who else is already on SeriesTrend.",
...
const defaultEsTranslations = {
  ...
  comingSoon: {
    ...
    title: "Red Social de",
    subtitle:
      "La próxima gran actualización añade una capa social para acercar a los fans de series dentro de la comunidad de SeriesTrend.",
    description:
      "Con integración social a través de Trakt.tv, podrás identificar amigos, seguir perfiles de la comunidad y descubrir quién más ya usa SeriesTrend.",
    traktBadge: "Integración con Trakt.tv",
    previewLabel: "Vista previa de la nueva pantalla social",
    highlights: [
      "Perfil social con seguidores, seguidos y amigos.",
      "Comunidad conectada a tu cuenta de Trakt.tv.",
      "Descubrimiento de perfiles y amistades dentro de la app.",
    ],
    note:
      "Algunas funciones sociales dependen de la autenticación con Trakt.tv y aún pueden ajustarse antes del lanzamiento oficial de la versión 4.0.",
    profileTitle: "Red Social",
    profileSubtitle: "Conéctate con otros fans de series",
    profileName: "Marcelo Lopes",
    profileHandle: "@EuMarceloCae",
    profileLocation: "Florianópolis, Santa Catarina",
    profileSince: "agosto de 2025",
    ...
    statsFriends: "Amigos",
    friendsTitle: "Amigos en SeriesTrend",
    friendName: "Folincontro Eventos",
    friendHandle: "@Folincontro",
    communityTitle: "Miembros de la Comunidad",
    emptyTitle: "Aún no apareció ningún perfil de la comunidad",
    emptyDescription:
      "Actualiza la comunidad para cargar nuevos perfiles y descubrir quién más ya usa SeriesTrend.",
...
const defaultZhTranslations = {
  ...
  comingSoon: {
    ...
    title: "社群功能即將登陸",
    subtitle:
      "下一次重大更新將為應用程式加入社交層，讓影集愛好者能在 SeriesTrend 社群中互相連結。",
    description:
      "透過 Trakt.tv 社群整合，你將能識別朋友、追蹤社群檔案，並發現還有哪些人已經在使用 SeriesTrend。",
    traktBadge: "Trakt.tv 整合",
    previewLabel: "新社交頁面的預覽",
    highlights: [
      "包含追蹤者、追蹤中與朋友的社群個人檔案。",
      "與你的 Trakt.tv 帳號連結的社群。",
      "在應用程式內探索檔案與好友關係。",
    ],
    note:
      "部分社群功能依賴 Trakt.tv 驗證，並可能在 4.0 正式推出前持續調整。",
    profileTitle: "社群",
    profileSubtitle: "與其他影集粉絲互相連結",
    profileName: "Marcelo Lopes",
    profileHandle: "@EuMarceloCae",
    profileLocation: "Florianópolis, Santa Catarina",
    profileSince: "2025 年 8 月",
    statsFollowers: "追蹤者",
    statsFollowing: "追蹤中",
    statsFriends: "朋友",
    friendsTitle: "SeriesTrend 上的朋友",
    friendName: "Folincontro Eventos",
    friendHandle: "@Folincontro",
    communityTitle: "社群成員",
    emptyTitle: "尚未出現任何社群檔案",
    emptyDescription:
      "重新整理社群以載入新檔案，看看還有哪些人也在使用 SeriesTrend。",
    refreshLabel: "立即重新整理",
    tabs: {
      series: "影集",
      search: "搜尋",
